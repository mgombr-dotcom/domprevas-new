...
<section className="relative bg-white text-black">
  ...
  <div className="relative z-20 mx-auto -mt-[500px] max-w-7xl px-6 lg:-mt-[520px]">
    <div className="grid overflow-hidden rounded-md bg-white shadow-2xl md:grid-cols-5">
      {[
        ...
        <div key={title} className="border-b border-neutral-200 p-7 md:border-b-0 md:border-r last:border-r-0">
